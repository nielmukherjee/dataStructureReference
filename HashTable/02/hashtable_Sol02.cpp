...
int main() {
    ...
    print_search(ht, const_cast<char*>("1"));
    print_search(ht, const_cast<char*>("2"));
    print_search(ht, const_cast<char*>("3"));
    print_search(ht, const_cast<char*>("Hel"));
    print_search(ht, const_cast<char*>("Cau")); // Collision!
    print_hashtable(ht);
